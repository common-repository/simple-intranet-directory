...
Donate link: https://www.simpleintranet.org/
Tags: intranet, extranet, private, employee, user photo, avatar, company, directory, profile, staff, out of office
...
Upgrade to the full version of our Simple Intranet (https://www.simpleintranet.org) plugin suite and get these features;
...
View these and more options at the "Simple Intranet" menu item in your Dashboard or visit http://www.simpleintranet.org.
...
== Changelog ==
= 3.8 =
* Updated deporecated widget code for latest WordPress 4.6+ versions.

= 3.7 =
* Fixed social icon formatting in the directory detailed biography pages.

= 3.6 =
* Added Location field to the User Profile options and main directory.

= 3.5 =
* Fixed pagination bug when directory appears on a static front page.
...
= 2.4 =
* Adds the option in Your Profile to allow public access
